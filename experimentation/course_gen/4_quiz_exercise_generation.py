...
course_note_fp = '/Users/rahulduggal/Documents/personal_learnings/learning-assistant-v1/experimentation/course_gen/course_generation_round_one/week_one_topic_one_course_notes_new_three.txt'
course_note_file = open(course_note_fp, 'r')
course_note_text = course_note_file.read().strip()

q_prompt = q_prompt.format(
    student_info = student_info_text,
    course_note_information = course_note_text
)
...
tmp_fp = os.path.join(output_dir_fp, f"week_one_topic_one_quiz_exercises.txt")
f = open(tmp_fp, 'w')
